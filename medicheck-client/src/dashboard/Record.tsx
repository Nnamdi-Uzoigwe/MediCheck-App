...
//       try {
//         // Fetch diagnoses
//         const resDiag = await fetch("https://medicheck-app-3.onrender.com/api/diagnosis", {
...
export default function Record() {
  ...
  <span className="text-[#005eaa] font-semibold">Symptoms:</span>{" "}
  {[
    ...Object.values(diag.symptoms.coreSymptoms || {}),
    ...Object.values(diag.symptoms.medicalHistory || {}),
    ...Object.values(diag.symptoms.supportingFactors || {}),
  ].join(", ")}
</p> */}
