...
//     }
//     return (
//         <div className="bg-white p-8 h-auto flex flex-col justify-center items-center">
//             <div onClick={handleOpen} className="flex flex-col font-semibold border-2 border-gray-300 cursor-pointer hover:bg-gray-100 rounded-[12px] px-6 py-3">
//                 Important Medical Information <span className="text-2xl">⚠️</span>

//                 <span className="text-sm text-gray-500">[click to read full disclaimer]</span>
//             </div>
...
//                             <button className="mt-10" onClick={handleClose}>See Less</button>
//                 </div>
//             )}
    ...
    return (
        <div className="bg-white py-16 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                {/* Expandable Content */}
                <div className={`overflow-hidden transition-all duration-500 ${open ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0'}`}>
