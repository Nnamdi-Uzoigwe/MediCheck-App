...
export default function Hero() {
    return (
        <div className="mt-24 text-white px-6 lg:px-40 flex flex-col-reverse lg:flex-row justify-center lg:justify-between items-center">
            ...
            <img src="/new4.png" alt="" className="w-[50%]" />
